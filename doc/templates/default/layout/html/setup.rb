...
# @since 0.7.0
def javascripts
  %w(js/jquery.js js/app.js js/bootstrap.min.js)
end

# @return [Array<String>] core stylesheets for the layout
# @since 0.7.0
def stylesheets
  %w(css/bootstrap.css css/syntax.css css/bootstrap-responsive.css css/style.css css/gooddata.css css/common.css)
end

# @return [Array<Hash{Symbol=>String}>] the list of search links and drop-down menus
# @since 0.7.0
def menu_lists
[ { :type => 'class', :title => 'Classes', :search_title => 'Classes' },
  { :type => 'method', :title => 'Methods', :search_title => 'Methods' },
  { :type => 'file', :title => 'Files', :search_title => 'Files' } ]
end
